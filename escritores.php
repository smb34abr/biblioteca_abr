      ...
      <div class="page-header">
        <div class="page-block">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Relación de escritores</li>
          </ul>
        </div>
      </div>
      <!-- [ breadcrumb ] end -->
        ...
        <div class="col-span-12">
          <div class="card">
            <div class="card-header flex justify-between items-center">
              ...
              <a href="form_escritor.php" class="btn bg-primary-700 mb-2">
              <h4 class="mb-0 font-medium" title="Nuevo escritor" style="color: white;">Nuevo</h4>
            </a>
            </div>
            <div class="card-body">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="delete_libros.php?id_libro=<?php echo $resultado['id_libro'] ?>"
