      ...
      <div class="page-header">
        <div class="page-block">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Relación de editoriales</li>
          </ul>
        </div>
      </div>
      <!-- [ breadcrumb ] end -->
        ...
        <div class="col-span-12">
          <div class="card">
            <div class="card-header flex justify-between items-center">
              <h3>Relación de editoriales</h3>
              <a href="form_editorial.php" class="btn bg-primary-700 mb-2">
              <h4 class="mb-0 font-medium" title="Nuevo editorial" style="color: white;">Nueva</h4>              
            </a>
            </div>
            <div class="card-body">
              ...
              <table id="example" class="display">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <?php echo $resultado['id_editorial'] ?>
                    </td>
                    <td>
                      <?php echo $resultado['nombre_editorial'] ?>
                    </td>
                    <td>
                      <?php echo $resultado['pais'] ?>
                    </td>
                    <td>
                      <a href="form_editoriales.php?id_editorial=<?php echo $resultado['id_editorial'] ?>"
                        class="btn btn-warning">
                        <i class="fa-solid fa-pencil"></i>
                      </a>
                      <a href="delete_editoriales.php?id_editorial=<?php echo $resultado['id_editorial'] ?>"
